...
OBJS += \
./examples/libs/gif/img_bulb_gif.o \
./examples/libs/gif/lv_example_gif_1.o 

C_DEPS += \
./examples/libs/gif/img_bulb_gif.d \
./examples/libs/gif/lv_example_gif_1.d 


# Each subdirectory must supply rules for building sources it contributes
examples/libs/gif/%.o examples/libs/gif/%.su: ../examples/libs/gif/%.c examples/libs/gif/subdir.mk
...
clean: clean-examples-2f-libs-2f-gif

clean-examples-2f-libs-2f-gif:
	-$(RM) ./examples/libs/gif/img_bulb_gif.d ./examples/libs/gif/img_bulb_gif.o ./examples/libs/gif/img_bulb_gif.su ./examples/libs/gif/lv_example_gif_1.d ./examples/libs/gif/lv_example_gif_1.o ./examples/libs/gif/lv_example_gif_1.su

.PHONY: clean-examples-2f-libs-2f-gif
