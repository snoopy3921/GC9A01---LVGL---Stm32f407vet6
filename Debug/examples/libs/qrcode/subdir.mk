...
OBJS += \
./examples/libs/qrcode/lv_example_qrcode_1.o 

C_DEPS += \
./examples/libs/qrcode/lv_example_qrcode_1.d 


# Each subdirectory must supply rules for building sources it contributes
examples/libs/qrcode/%.o examples/libs/qrcode/%.su: ../examples/libs/qrcode/%.c examples/libs/qrcode/subdir.mk
...
clean: clean-examples-2f-libs-2f-qrcode

clean-examples-2f-libs-2f-qrcode:
	-$(RM) ./examples/libs/qrcode/lv_example_qrcode_1.d ./examples/libs/qrcode/lv_example_qrcode_1.o ./examples/libs/qrcode/lv_example_qrcode_1.su

.PHONY: clean-examples-2f-libs-2f-qrcode
