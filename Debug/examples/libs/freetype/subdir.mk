...
OBJS += \
./examples/libs/freetype/lv_example_freetype_1.o 

C_DEPS += \
./examples/libs/freetype/lv_example_freetype_1.d 


# Each subdirectory must supply rules for building sources it contributes
examples/libs/freetype/%.o examples/libs/freetype/%.su: ../examples/libs/freetype/%.c examples/libs/freetype/subdir.mk
...
clean: clean-examples-2f-libs-2f-freetype

clean-examples-2f-libs-2f-freetype:
	-$(RM) ./examples/libs/freetype/lv_example_freetype_1.d ./examples/libs/freetype/lv_example_freetype_1.o ./examples/libs/freetype/lv_example_freetype_1.su

.PHONY: clean-examples-2f-libs-2f-freetype
