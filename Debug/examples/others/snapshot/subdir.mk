...
OBJS += \
./examples/others/snapshot/lv_example_snapshot_1.o 

C_DEPS += \
./examples/others/snapshot/lv_example_snapshot_1.d 


# Each subdirectory must supply rules for building sources it contributes
examples/others/snapshot/%.o examples/others/snapshot/%.su: ../examples/others/snapshot/%.c examples/others/snapshot/subdir.mk
...
clean: clean-examples-2f-others-2f-snapshot

clean-examples-2f-others-2f-snapshot:
	-$(RM) ./examples/others/snapshot/lv_example_snapshot_1.d ./examples/others/snapshot/lv_example_snapshot_1.o ./examples/others/snapshot/lv_example_snapshot_1.su

.PHONY: clean-examples-2f-others-2f-snapshot
