...
OBJS += \
./examples/widgets/win/lv_example_win_1.o 

C_DEPS += \
./examples/widgets/win/lv_example_win_1.d 


# Each subdirectory must supply rules for building sources it contributes
examples/widgets/win/%.o examples/widgets/win/%.su: ../examples/widgets/win/%.c examples/widgets/win/subdir.mk
...
clean: clean-examples-2f-widgets-2f-win

clean-examples-2f-widgets-2f-win:
	-$(RM) ./examples/widgets/win/lv_example_win_1.d ./examples/widgets/win/lv_example_win_1.o ./examples/widgets/win/lv_example_win_1.su

.PHONY: clean-examples-2f-widgets-2f-win
